...
urlpatterns = [
    ...
    path('edit-shift-Ajax/delete-shiftdata/',views.editshift_ajax_delete,name='editshift-ajax-delete'),
    path('edit-shift-Ajax/post-shiftdata/',views.editshift_ajax_post_shiftdata,name='edit-shift-Ajax-post-shiftdata'),
    path('edit-shift-Ajax/post-shiftdata/delete-shiftdata/',views.editshift_ajax_delete_shiftdata,name='editshift-ajax-delete-shiftdata'),
